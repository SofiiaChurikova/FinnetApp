namespace EvolutionaryArchitecture.Fitnet.Modules.Offers.Domain.Entities;
...
public sealed class Offer
{
    ...
    private Offer(Guid id, Guid customerId, DateTimeOffset preparedAt,
        decimal discount, DateTimeOffset offeredFromDate, DateTimeOffset offeredFromTo)
    {
        Id = id;
